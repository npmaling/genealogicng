...
CREATE TABLE resproj (
  ...
  projectid INT NOT NULL,
  researcherid INT NOT NULL,
  rsearcherrole TEXT(32) NOT NULL,
...
CREATE TABLE citationparttype (
  ...
  citationparttypename TEXT(32) NOT NULL
...
--  FOREIGN KEY (SURETYPARTID) REFERENCES SURETYPART (SURETYPARTID),
--  FOREIGN KEY (RESEARCHERID) REFERENCES RESEARCHER (RESEARCHERID),
--  FOREIGN KEY (SOURCEID) REFERENCES SOURCE (SOURCEID)
);
...
CREATE TABLE search (
  ...
  activityid INT NOT NULL, -- relates to ACTIVITY
  sourceid INT NOT NULL,
  repositoryid INT NOT NULL,
